...
/*			long l = System.currentTimeMillis() - testStepTempTime;
       ...
       //      ImageIO.write(screenFullImage, format, new File(snapShotFolder+"//"+ fileName));
          ...
          }else if(((Parameter == "Y") || (Parameter == "N")) && (Parameter1.equalsIgnoreCase("Pass"))){
       //   ImageIO.write(screenFullImage, format, new File(snapShotFolder+"//"+ fileName));
            File f=((TakesScreenshot)BaseClass.driver).getScreenshotAs(OutputType.FILE);
              FileUtils.copyFile(f, new File(snapShotFolder+"\\"+fileName));
             snapShotPathList.add(fileName);
...
/*		if (!testFolder.exists())
	...
	public  void readTestDataFile(String filePath, String tcID) throws Exception{
		...
		try{
			...
			if(str1.contains("IntroScreenTestCases"))
			{
			...
			String str2=workbook.getSheetName(2); 
			//System.out.println(str2+"customer loginS");
			if(str2.equalsIgnoreCase("PattabhiLoginTestCases"))
			{
				worksheet=workbook.getSheet(str2);
				Row Headertrow = worksheet.getRow(0);
			...
			String str3=workbook.getSheetName(3); 
			//System.out.println(str2+"customer loginS");
			if(str3.equalsIgnoreCase("ProfileTestCases"))
			{
				worksheet=workbook.getSheet(str3);
				Row Headertrow = worksheet.getRow(0);
				System.out.println(Headertrow.getCell(0)+"+++++");
				int totalrows = worksheet.getLastRowNum()-worksheet.getFirstRowNum();
				int startValue=Integer.parseInt(tcID);
			...
			String str4=workbook.getSheetName(4); 
			//System.out.println(str2+"customer loginS");
			if(str4.equalsIgnoreCase("HomePageTestCases"))
			{
				worksheet=workbook.getSheet(str4);
				Row Headertrow = worksheet.getRow(0);
				System.out.println(Headertrow.getCell(0)+"+++++");
				int totalrows = worksheet.getLastRowNum()-worksheet.getFirstRowNum();
				int startValue=Integer.parseInt(tcID);
			...
			String str5=workbook.getSheetName(5); 
			//System.out.println(str2+"customer loginS");
			if(str5.equalsIgnoreCase("ProductandRestaurantSearch"))
			{
				worksheet=workbook.getSheet(str5);
				Row Headertrow = worksheet.getRow(0);
				System.out.println(Headertrow.getCell(0)+"+++++");
				int totalrows = worksheet.getLastRowNum()-worksheet.getFirstRowNum();
				int startValue=Integer.parseInt(tcID);
			...
			String str6=workbook.getSheetName(6); 
			//System.out.println(str2+"customer loginS");
			if(str6.equalsIgnoreCase("MerchantView"))
			{
				worksheet=workbook.getSheet(str6);
				Row Headertrow = worksheet.getRow(0);
				System.out.println(Headertrow.getCell(0)+"+++++");
				int totalrows = worksheet.getLastRowNum()-worksheet.getFirstRowNum();
				int startValue=Integer.parseInt(tcID);
			...
			String str7=workbook.getSheetName(7); 
			//System.out.println(str2+"customer loginS");
			if(str7.equalsIgnoreCase("CartFunctionality"))
			{
				worksheet=workbook.getSheet(str7);
				Row Headertrow = worksheet.getRow(0);
				System.out.println(Headertrow.getCell(0)+"+++++");
				int totalrows = worksheet.getLastRowNum()-worksheet.getFirstRowNum();
				int startValue=Integer.parseInt(tcID);
			...
			String str8=workbook.getSheetName(8); 
			//System.out.println(str2+"customer loginS");
			if(str8.equalsIgnoreCase("AddressFunctionality"))
			{
				worksheet=workbook.getSheet(str8);
				Row Headertrow = worksheet.getRow(0);
				System.out.println(Headertrow.getCell(0)+"+++++");
				int totalrows = worksheet.getLastRowNum()-worksheet.getFirstRowNum();
				int startValue=Integer.parseInt(tcID);
			...
			localAutomationException.printStackTrace();
